...
RequestDetail,
RequestDetails,
} from '@/interfaces/RequestDetails'
...
const currentNewFilesCount =
newFiles.value.length

const totalFiles =
existingCount + currentNewFilesCount

if (totalFiles >= MAX_FILES) {
fileError.value =
'לא ניתן לצרף קבצים נוספים '
